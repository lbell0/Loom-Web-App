...
<div class="container col-sm-8">
  ...
  <div class="text-center">
      <em><br>Thanks for joining us! You are now set to navigate through Loom. <br><br> Check out the <a href="menu-nav.php"><strong>menu features</strong></a> and everything else that we have to offer!
      <div class="text-center"><br><br>
          <img src="img/food.png" alt="Ready to eat?" height="250" width="700">
      </div>
  </div>
</div>
